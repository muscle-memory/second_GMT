...
class _LineChartScreenState extends State<LineChartScreen> {
  ...
  void _updateTooltip(Offset position, transformedPosition, Size containerSize, double containerHeight) {
  ...
  Map<String, double>? _findPointByRatio(
      double clickedX, double containerWidth) {
                ...
                return GestureDetector(
                  onTapDown: (TapDownDetails details) {
                    ...
                    Offset transformedPosition =
                        (localPosition - transPosition) / scaleX;

                    print('OFFSET => $transformedPosition');
